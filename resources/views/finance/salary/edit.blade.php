        ...
        <div class="info-box">
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <div class="info-value blue">{{ $salary->teacher->full_name ?? 'N/A' }}</div>
                </div>
                <div class="info-item">
                    <div class="info-label"><i class="fas fa-calendar-alt"></i> Month</div>
                    <div class="info-value orange">{{ $salary->month_name }}</div>
                </div>
                <div class="info-item">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value purple">{{ ucfirst($salary->salary_type) }}</div>
                </div>
            </div>
        </div>
...
function updateSalary(event) {
    ...
    fetch('{{ route("finance.salary.update", $salary->id) }}', {
        method: 'PUT',
        headers: {

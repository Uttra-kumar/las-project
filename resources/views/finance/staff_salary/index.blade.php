...
<style>
    ...
    .badge-paid { background: #dcfce7; color: #15803d; padding: 2px 10px; border-radius: 20px; font-size: 0.6rem; font-weight: 600; }
    .badge-hold { background: #fee2e2; color: #dc2626; padding: 2px 10px; border-radius: 20px; font-size: 0.6rem; font-weight: 600; }
    .badge-bank { background: #dbeafe; color: #1e40af; padding: 2px 8px; border-radius: 20px; font-size: 0.6rem; font-weight: 600; }
    .badge-cash { background: #fef3c7; color: #b45309; padding: 2px 8px; border-radius: 20px; font-size: 0.6rem; font-weight: 600; }
...
<div class="salary-container">
    <div class="salary-header">
        <h2><i class="fas fa-money-bill-wave"></i> Staff Salary List</h2>
        <div>
            ...
            <a href="{{ route('finance.staff-salary.create') }}" class="btn-add">
    ...
    <div class="filter-card">
        <form method="GET">
                ...
                <div class="filter-item">
                    <a href="{{ route('finance.staff-salary.index') }}" class="btn-reset" style="text-decoration:none; color:white;">
                ...
                <div class="filter-item">
                    <a href="{{ route('finance.staff-salary.export', request()->query()) }}" class="btn-csv" style="text-decoration:none; color:white;">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><strong>{{ $salary->staff->emp_id ?? 'N/A' }}</strong></td>
                    <td>{{ $salary->staff->full_name ?? 'N/A' }}</td>
                    <td><span style="background:#dbeafe; color:#1e40af; padding:2px 8px; border-radius:4px; font-size:0.55rem;">{{ ucfirst($salary->staff->department ?? 'N/A') }}</span></td>
                    ...
                    <td>
                        <div class="action-btns">
                            <a href="{{ route('finance.staff-salary.edit', $salary->id) }}" class="btn-edit" title="Edit">

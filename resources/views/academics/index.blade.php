...
<div class="academics-container">
    ...
    <div class="top-bar">
        <div class="search-wrapper">
            <input type="text" id="searchInput" placeholder="Search by class name or class ID..." autocomplete="off">
            <button onclick="searchClasses()"><i class="fas fa-search"></i> Search</button>
        </div>
    ...
    <div id="classesTableWrapper">
        @include('academics.classes-table', ['classes' => $classes])
    </div>
</div>
        ...
        <form id="classForm">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="className" name="class_name" required placeholder="e.g., Class 10, Class 12 Science">
                </div>
...
<script>
    ...
    document.getElementById('classForm').addEventListener('submit', function(e) {
        ...
        const url = classId ? `/classes/update/${classId}` : '/classes/store';
    ...
    function searchClasses() {
        ...
        fetch(`/classes/search?search=${encodeURIComponent(search)}`)
            .then(response => response.text())
            .then(html => {
                // Only update the table wrapper, not the whole page
                document.getElementById('classesTableWrapper').innerHTML = html;
            })
            .catch(error => {
